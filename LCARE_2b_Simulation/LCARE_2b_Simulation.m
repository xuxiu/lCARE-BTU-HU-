...
% ---------------------------------------------------------------------
% See also:     LCARE_2a_rsn, LCARE_2c_Simulation, 
% ---------------------------------------------------------------------
...
y_sim_005       = zeros(size(er_005, 1) + 1, length(er_005)); 
y_sim_005(1, :) = 0.00045;
y_sim_plus_005  = zeros(size(y_sim_005)); 
y_sim_neg_005   = zeros(size(y_sim_005));
...
y_sim_001       = zeros(size(er_001, 1) + 1, length(er_001)); 
y_sim_001(1, :) = 0.00045;
y_sim_plus_001  = zeros(size(y_sim_001)); 
y_sim_neg_001   = zeros(size(y_sim_001));
